...
calculateSum(); //First calculate with default parameters
...
function calculateSum() {
  ...
  // console.log("web-site type", websiteTypeValue);
  // console.log("technologi Sum", technologiesValue);
  // console.log("web-site cart", websiteCartValue);
  // console.log("web-site Reception", websiteReceptionValue);
}
