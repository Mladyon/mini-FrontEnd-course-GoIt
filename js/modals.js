...
const thanksCloseBtns = document.querySelectorAll(".thanks-close-btn");
...
const modals = [mobileMenu, myVideoModal]; //requestReceived
const buttons = [mobileMenuBtn, myVideoBtn, callbackSubmitBtn];
